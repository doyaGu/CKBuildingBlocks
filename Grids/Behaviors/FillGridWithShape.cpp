...
CKObjectDeclaration *FillBehaviorFillGridWithShapeDecl()
{
    ...
    <BR>
    <SPAN CLASS=pin>Object: </SPAN>to to get shape from.<BR>
    ...
    <BR>
    The "3D Entity Fill" building block fill grids squares with an object shape & surface.<BR>
    */
...
CKERROR CreateFillGridWithShapeProto(CKBehaviorPrototype **pproto)
{
    ...
    proto->DeclareInParameter("Value", CKPGUID_INT, "255"); /// 2DO : Type du parametre d'entr�e variable
