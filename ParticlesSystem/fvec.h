...
public:
    ...
    friend F32vec4 add_horizontal_ps(F32vec4 &a)
    {
...
public:
    ...
    __m128 Shuffle()
    {
        return _mm_shuffle_ps(vec, vec, 0);
    }
    /* Conversion functions */
    ...
    friend F32vec1 add_horizontal_ss3(F32vec4 &a)
    {
...
// F32vec4::F32vec4(const F32vec1& a)			{ vec = a; _mm_shuffle_ps(vec,vec,0); }
