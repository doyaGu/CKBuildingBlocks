...
CKWORD *ParticleEmitter::m_GlobalIndices = 0;
...
void ParticleEmitter::ReadSettings(CKBehavior *beh)
{
    ...
    else if (m_RenderMode == PR_FIXEDPOINTSPRITE)
        m_RenderParticlesCallback = RenderParticles_FPS;
